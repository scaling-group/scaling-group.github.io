...
Our work centers on In-Context Operator Networks (ICON), a foundation-model framework for scientific problems. Through this lens, we study directions including multi-physics prediction, physical modeling, and embodied AI, where our recent project [VICX](https://scaling-group.github.io/vicx/) explores generalizable robot manipulation via video generation and in-context execution. To accelerate our research, we also develop agents ([EvE](https://github.com/scaling-group/eve)) for automated discovery of algorithms and beyond.
