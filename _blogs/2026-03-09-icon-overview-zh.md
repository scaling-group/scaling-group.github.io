...
这篇工作研究如何在不更新参数的情况下，把一个冻结的 ICON 泛化到分布外任务上。借助[Evolutionary Ensemble of Agents (EvE)](https://github.com/scaling-group/eve)，我们寻找到 Chain of Operators（CHOP）来用显式的初等变换包装 ICON，以一种可解释的方式把困难任务移动到冻结模型更有能力处理的区域。
